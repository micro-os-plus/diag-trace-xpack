...
- name the post like: **µOS++ libs-cpp v2.2.1 released**
...
- `npm dist-tag add @micro-os-plus/libs-cpp@2.2.1 latest`
- `npm dist-tag ls @micro-os-plus/libs-cpp`
...
- paste the release name like **µOS++ libs-cpp v2.2.1 released**
