...
[GitHub Actions](https://github.com/micro-os-plus/diag-trace-xpack/actions/workflows/publish-github-pages.yml).

- Open https://micro-os-plus.github.io/diag-trace-xpack/docs/maintainer/#publish-the-website in a separate window
...
- **Push** the `website` branch to GitHub
  ...
  the [website](https://micro-os-plus.github.io/diag-trace-xpack/).
  :::
- Check out the `xpack-development` branch
- **Wait** for the publication to complete 
- check [GitHub Pages](https://github.com/micro-os-plus/diag-trace-xpack/actions/workflows/publish-github-pages.yml) workflow
- **Refresh** the web page
- The new release blog post is available
at https://micro-os-plus.github.io/diag-trace-xpack/blog/
...
Verify the result at https://micro-os-plus.github.io/diag-trace-xpack/.
