...
- Execute the **generate-website-blog-post** npm script; this will add a file to the `website/blog` folder:
  ```sh
  npm --prefix ~/Work/micro-os-plus/diag-trace-xpack.git/website run generate-website-blog-post
  ```
...
- Add entries in the **Bug fixes**; utilise the following syntax
  ```
  - [[#N](https://github.com/micro-os-plus/diag-trace-xpack/issues/N)]:
  ```
- **Commit** with the message _**website: blog post release 4.2.3 published**_
