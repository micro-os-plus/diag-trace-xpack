...
<p>Project-specific Doxygen group definitions. <a href="#details">More...</a></p>

## Description {#details}

<p>Project-specific Doxygen group definitions.</p>


<p>This file defines the documentation groups (topics) for the µOS++ Tracing Infrastructure. Although it uses a <span class="doxyComputerOutput">.h</span> extension, it is not part of the build; it is processed exclusively by Doxygen. The <span class="doxyComputerOutput">.h</span> extension is required because Doxygen does not process arbitrary file extensions in the same way as recognised header files.</p>


<p>This file is located in <span class="doxyComputerOutput">website/doxygen/</span> and is referenced via <span class="doxyComputerOutput">@include{doc}</span> from <span class="doxyComputerOutput"><a href="/diag-trace-xpack/docs/api/files/topics-h">topics.h</a></span>.</p>
