...
title: µOS++ Tracing Infrastructure v3.0.0 released
...
release_tag_url: "https://github.com/micro-os-plus/diag-trace-xpack/tree/v3.0.0"
...
- rename `MICRO_OS_PLUS_TRACE`
- update cmake & meson configs
