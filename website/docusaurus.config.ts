...
const config: Config = {
  title: 'µOS++ Tracing Infrastructure' +
    ((process.env.DOCUSAURUS_IS_PREVIEW === 'true') ? ' (preview)' : ''),
  tagline: 'A C/C++ source code library with the µOS++ tracing infrastructure',
  ...
  projectName: 'diag-trace-xpack', // Usually your repo name.
  ...
  plugins: [
    [
      '@docusaurus/plugin-content-docs',
      {
        ...
        editUrl: 'https://github.com/micro-os-plus/diag-trace-xpack/edit/website/website/',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/micro-os-plus/diag-trace-xpack/',
          position: 'right',
        ...
        },
        {
          ...
          items: [
            {
              label: `diag-trace-xpack project`,
              href: `https://github.com/micro-os-plus/diag-trace-xpack/`,
            },
            {
        ...
        },
        {
          ...
          position: 'right',
          href: `https://www.npmjs.com/package/@micro-os-plus/diag-trace/v/${customFields.releaseVersion}`,
        },
      ],
    },
    footer: {
      ...
      links: [
          ...
          items: [
            {
              ...
              href: 'https://github.com/micro-os-plus/diag-trace-xpack/discussions',
            },
            {
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'GitHub diag-trace-xpack project',
              href: 'https://github.com/micro-os-plus/diag-trace-xpack/',
            },
            {
