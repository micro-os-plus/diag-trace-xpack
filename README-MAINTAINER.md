...
- name the post like: **µOS++ diag-trace v2.4.1 released**
...
- `npm dist-tag add @micro-os-plus/diag-trace@2.4.1 latest`
- `npm dist-tag ls @@micro-os-plus/diag-trace`
...
- paste the release name like **µOS++ diag-trace v2.4.1 released**
