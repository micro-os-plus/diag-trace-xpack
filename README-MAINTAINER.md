...
- name the file like `2020-12-19-diag-trace-v0-1-0-released.md`
- name the post like: **µOS++ diag-trace v1.0.7 released**
...
- commit all changes
- update `CHANGELOG.md`; commit with a message like _CHANGELOG: prepare v1.0.7_
...
- `npm dist-tag add @micro-os-plus/diag-trace@1.0.7 latest`
- `npm dist-tag ls @@micro-os-plus/diag-trace`
...
- paste the release name like **µOS++ diag-trace v1.0.7 released**
