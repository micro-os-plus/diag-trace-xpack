...
- name the post like: **µOS++ diag-trace v1.1.0 released**
...
- `npm dist-tag add @micro-os-plus/diag-trace@1.1.0 latest`
- `npm dist-tag ls @@micro-os-plus/diag-trace`
...
- paste the release name like **µOS++ diag-trace v1.1.0 released**
