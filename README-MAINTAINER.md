...
Determine the upstream version (like `4.2.3`) and eventually update the
`package.json` file; the format is `4.2.3-pre`.
...
and fix them; assign them to a milestone (like `4.2.3`).
