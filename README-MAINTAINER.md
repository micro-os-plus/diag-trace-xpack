...
- name the post like: **µOS++ diag-trace v2.2.0 released**
...
- commit all changes
- update `CHANGELOG.md`; commit with a message like _CHANGELOG: prepare v2.2.0_
...
- `npm dist-tag add @micro-os-plus/diag-trace@2.2.0 latest`
- `npm dist-tag ls @@micro-os-plus/diag-trace`
...
- paste the release name like **µOS++ diag-trace v2.2.0 released**
