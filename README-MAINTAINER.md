...
- name the post like: **µOS++ diag-trace v2.2.4 released**
...
- update `CHANGELOG.md`
- commit with a message like _prepare v2.2.4_
...
- `npm dist-tag add @micro-os-plus/diag-trace@2.2.4 latest`
- `npm dist-tag ls @@micro-os-plus/diag-trace`
...
- paste the release name like **µOS++ diag-trace v2.2.4 released**
